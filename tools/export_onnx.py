...
def main(args, ):
    ...
    data = torch.rand(1, 3, 1600, 2400)
    size = torch.tensor([[1600, 2400]])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', '-c', type=str, default='D:/Medical_segmentation/Kingmed/RT-DETR-main/rtdetrv2_pytorch/configs/rtdetrv2/rtdetrv2_r50vd_organoid_113.yml')
    parser.add_argument('--resume', '-r', type=str, default='D:/Medical_segmentation/Kingmed/RT-DETR-main/rtdetrv2_pytorch/tools/output/rtdetrv2_r50vd_organoid_113_test_16002400_epoch100/best.pth')
    parser.add_argument('--file-name', '-f', type=str, default='model_113_static.onnx')
