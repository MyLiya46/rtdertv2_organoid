...
class MotChallenge2DBox(_BaseDataset):
    """Dataset class for mot_challenge Challenge 2D bounding box tracking"""
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'SEQMAP_FOLDER': 'D:/Medical_segmentation/Kingmed/MOTIP-main/TrackEval/data/gt/mot_challenge/seqmaps/',  # Where seqmaps are found (if None, GT_FOLDER/seqmaps)
    ...
    def _get_seq_info(self):
        ...
        if self.config["SEQ_INFO"]:
            ...
            if not os.path.isfile(seqmap_file):
                print('seq folder:', self.config['SEQMAP_FOLDER'])
                print('gt set:', self.gt_set)
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        """Load a file (gt or tracker) in the mot_challenge Challenge 2D box format
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        mot_challenge Challenge:
            In mot_challenge Challenge, the 4 preproc steps are as follow:
