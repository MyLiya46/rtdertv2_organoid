...
def make_parser():
    ...
    parser.add_argument(
        ...
        "--exp_file",
        # default=None,
        default='D:/Medical_segmentation/Kingmed/ByteTrack-main/exps/example/mot/yolox_x_ablation.py',
        type=str,
    ...
    parser.add_argument("-c", "--ckpt",
                        default='D:/Medical_segmentation/Kingmed/ByteTrack-main/pretrained/bytetrack_ablation.pth.tar',
...
def main(exp, args, num_gpu):
    ...
    results_folder = os.path.join('D:/Medical_segmentation/Kingmed/ByteTrack-main/', file_name, "track_results")
