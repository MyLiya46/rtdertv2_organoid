...
if __name__ == '__main__':
    ...
    # parser.add_argument('--config', type=str, default='D:/Medical_segmentation/Kingmed/RT-DETR-main/rtdetrv2_pytorch/configs/rtdetrv2/rtdetrv2_r50vd_6x_coco.yml')
    # parser.add_argument('--resume', type=str, help='resume from checkpoint', default='D:/Medical_segmentation/Kingmed/RT-DETR-main/rtdetrv2_pytorch/tools/output/rtdetrv2_r50vd_6x_coco_epoch150/best.pth')
    # parser.add_argument( '--resume', type=str, help='resume from checkpoint', default='D:/Medical_segmentation/Kingmed/RT-DETR-main/rtdetrv2_pytorch/tools/output/rtdetrv2_r50vd_organoid_113/best.pth')
